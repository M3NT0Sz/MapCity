-- ============================================================================ 
-- MAPCITY - CONFIGURAÇÃO COMPLETA DO BANCO DE DADOS (ATUALIZADA)
-- Este arquivo contém toda a estrutura necessária para o MapCity, incluindo as últimas correções
